"""
File containing the find_convex_hull_points function definition.
"""
...
def find_convex_hull_points(list_of_points_on_contour,
                ...
                if j != first_found_point_index:
                    ...
                    if return_indices:
                        ...
                        if i < 0:
                            ...
                            # Add the length of the contour to make it positive
                            external_points.append(i + len(list_of_points_on_contour))

                        # Otherwise, add the index as is
                        else:
...
if __name__ == '__main__':
    ...
    print(find_convex_hull_points(test_contour, False))
