...
from cv2 import cvtColor, COLOR_BGR2GRAY, COLOR_BGR2RGB, COLOR_GRAY2RGB, COLOR_GRAY2BGR, GC_PR_BGD, GC_BGD, GC_FGD, imshow, waitKey
...
from validation_constants import FOLDER_PATH, INITIALIZATION_FILE_NAME, CROP_FILE_NAME, GROUND_TRUTH_FILE_NAME
...
images_as_arrays = generate_list_of_image_arrays('/home/ben/thyroid_ultrasound/src/thyroid_ultrasound_imaging/scripts'
                                                 '/Test/Images/Experiment_2024-01-02', image_start_index)
...
if True:
    save(FOLDER_PATH + INITIALIZATION_FILE_NAME, result_mask)
    save(FOLDER_PATH + CROP_FILE_NAME, array(image_filter.image_crop_coordinates))
    save(FOLDER_PATH + GROUND_TRUTH_FILE_NAME, ground_truth_mask)
